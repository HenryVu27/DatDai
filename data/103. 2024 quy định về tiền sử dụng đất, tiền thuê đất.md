...
3. Diện tích tính tiền sử dụng đất theo quy định tại khoản 1, khoản 2 Điều này được tính theo đơn vị mét vuông (m²).
...
$$\text{Tiền sử dụng đất} = \text{Diện tích đất tính tiền sử dụng đất} \times \text{Giá đất tính tiền sử dụng đất}$$
...
$$\begin{matrix} \text{Tiền sử dụng đất} \\ \text{phân bổ cho từng} \\ \text{đối tượng} \end{matrix} = \frac{\text{Tiền sử dụng đất tính theo quy định tại khoản 1 Điều này}}{\text{Tổng diện tích sàn sử dụng}} \times \begin{matrix} \text{Diện tích sàn sử} \\ \text{dụng của từng đối} \\ \text{tượng được giao} \end{matrix}$$
...
1. Khi được cơ quan nhà nước có thẩm quyền cho phép chuyển mục đích sử dụng đất để thực hiện dự án nhà ở thương mại đáp ứng đủ điều kiện quy định tại khoản 3 Điều 122 Luật Đất đai, dự án đầu tư hạ tầng nghĩa trang để chuyển nhượng quyền sử dụng đất gắn với hạ tầng, xây dựng cơ sở lưu giữ tro cốt quy định tại khoản 2 Điều 119 Luật Đất đai mà phải nộp tiền sử dụng đất

6

theo quy định tại khoản 1 và khoản 2 Điều 121, Điều 156 Luật Đất đai thì tiền sử dụng đất được tính như sau:
...
| Tiền sử dụng đất của loại đất sau khi chuyển mục đích sử dụng đất | = | Diện tích đất tính tiền sử dụng đất sau khi chuyển mục đích theo quy định tại Điều 4 Nghị định này | x | Giá đất tính tiền sử dụng đất theo quy định tại khoản 2 Điều 5 Nghị định này |
| ----------------------------------------------------------------- | - | -------------------------------------------------------------------------------------------------- | - | ---------------------------------------------------------------------------- |
...
ban hành quyết định cho phép chuyển mục đích sử dụng đất để xác định tiền đất trước khi chuyển mục đích được trừ vào tiền sử dụng đất của dự án.
...
$$ \text{Tiền đất trước khi chuyển mục đích sử dụng đất} = \frac{\begin{array}{c} \text{Diện tích đất có thu tiền sử dụng đất, thu tiền thuê đất nhân (x) giá đất} \\ \text{tương ứng với thời hạn giao đất, cho thuê đất của đất trước khi chuyển mục đích} \end{array}}{\text{Thời hạn giao đất, cho thuê đất của đất trước khi chuyển mục đích}} \times \begin{array}{c} \text{Thời hạn sử dụng} \\ \text{đất còn lại} \end{array} $$
...
$$ \begin{array}{c} \text{Tiền đất trước khi chuyển} \\ \text{mục đích sử dụng đất} \end{array} = \begin{array}{c} \text{Diện tích đất nông nghiệp} \\ \text{được chuyển mục đích sử} \\ \text{dụng đất} \end{array} \text{ x } \begin{array}{c} \text{Giá đất của loại} \\ \text{đất nông nghiệp} \\ \text{tương ứng} \end{array} $$

c) Đối với đất trước khi chuyển mục đích là đất phi nông nghiệp không phải là đất ở có thời hạn sử dụng ổn định lâu dài được Nhà nước giao đất có

thu tiền sử dụng đất trước ngày 01 tháng 7 năm 2004 (mà người sử dụng đất trước đó đã hoàn thành nghĩa vụ tài chính về tiền sử dụng đất) thì tiền đất trước khi chuyển mục đích sử dụng đất được tính bằng (=) diện tích đất nhân (x) với giá đất của loại đất phi nông nghiệp tương ứng của thời hạn 70 năm.
...
$$ \begin{matrix} \text{Tiền sử dụng đất khi} \\ \text{chuyển mục đích sử} \\ \text{dụng đất sang đất ở} \end{matrix} = \begin{matrix} \text{Tiền sử dụng đất của loại} \\ \text{đất sau khi chuyển mục} \\ \text{đích sử dụng đất} \end{matrix} - \begin{matrix} \text{Tiền sử dụng đất, tiền} \\ \text{thuê đất của các loại đất} \\ \text{trước khi chuyển mục} \\ \text{đích sử dụng đất (nếu có)} \end{matrix} $$

Trong đó:

- Tiền sử dụng đất của loại đất sau khi chuyển mục đích sử dụng đất được tính như sau:

$$ \begin{matrix} \text{Tiền sử dụng đất} \\ \text{của loại đất sau} \\ \text{khi chuyển mục} \\ \text{đích sử dụng đất} \end{matrix} = \begin{matrix} \text{Diện tích đất tính tiền sử} \\ \text{dụng đất sau khi chuyển} \\ \text{mục đích theo quy định tại} \\ \text{Điều 4 Nghị định này} \end{matrix} \times \begin{matrix} \text{Giá đất tính tiền sử} \\ \text{dụng đất theo quy định} \\ \text{tại khoản 1 Điều 5} \\ \text{Nghị định này} \end{matrix} $$
...
$$ \begin{matrix} \text{Tiền đất trước} \\ \text{khi chuyển} \\ \text{mục đích sử} \\ \text{dụng đất} \end{matrix} = \frac{\begin{matrix} \text{Diện tích đất có thu tiền thuê đất nhân (x) giá} \\ \text{đất tương ứng với thời hạn cho thuê đất của} \\ \text{đất trước khi chuyển mục đích} \end{matrix}}{\begin{matrix} \text{Thời hạn cho thuê đất của đất trước khi} \\ \text{chuyển mục đích} \end{matrix}} \times \begin{matrix} \text{Thời hạn sử} \\ \text{dụng đất còn} \\ \text{lại} \end{matrix} $$
...
$$
Tiền đất trước = \frac{Diện tích đất nhân (x) giá đất tương}{Thời hạn giao đất, cho thuê đất của đất} \times Thời hạn sử
$$
$$
khichuyển \quad ứng với thời hạn giao đất, cho thuê đất \quad dụng đất còn lại
$$
$$
mục đích sử \quad của đất trước khi chuyển mục đích \quad của đất
$$
$$
dụng đất \quad trước khi chuyển mục đích
$$
...
Trường hợp tiền sử dụng đất và khoản phải nộp bổ sung quy định tại điểm này vượt quá số tiền sử dụng đất tính theo chính sách và giá đất tại thời điểm

12

nộp đủ hồ sơ hợp lệ xin cấp Giấy chứng nhận theo quy định của pháp luật thì được tính theo giá đất và chính sách tại thời điểm nộp đủ hồ sơ hợp lệ.
...
b) Trường hợp hộ gia đình, cá nhân được cấp Giấy chứng nhận theo quy định tại khoản 4, khoản 5 Điều 137 Luật Đất đai mà người chuyển nhượng chưa nộp tiền sử dụng đất thì ngoài việc phải thực hiện nghĩa vụ về thuế, phí, lệ phí (nếu có) theo quy định của pháp luật về thuế, phí, lệ phí và pháp luật có liên quan, hộ gia đình, cá nhân đề nghị cấp Giấy chứng nhận còn phải nộp tiền sử dụng đất được tính theo quy định tại khoản 1, khoản 2 Điều này.
...
$$
Tiền sử dụng đất = \frac{Diện tích đất vượt hạn mức được công nhận đất ở}{} \times \frac{Giá đất ở quy định tại Bảng giá đất}{} \times 20\%
$$
...
$$
Tiền sử dụng đất = \frac{Diện tích đất của loại đất được công nhận}{} \times \frac{Giá đất của loại đất được công nhận quy định tại Bảng giá đất}{} \times 30\%
$$
...
$$
Tiền sử dụng đất = \frac{Diện tích đất vượt hạn mức được công nhận đất ở}{} \times \frac{Giá đất ở quy định tại Bảng giá đất}{} \times 40\%
$$
...
$$
Tiền sử dụng đất = \frac{Diện tích đất của loại đất được công nhận}{} \times \frac{Giá đất của loại đất được công nhận quy định tại Bảng giá đất}{} \times 50\%
$$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{công nhận trong} \\ \text{hạn mức giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 20\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{công nhận vượt} \\ \text{hạn mức giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 50\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất của} \\ \text{loại đất được} \\ \text{công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất được} \\ \text{công nhận quy định tại} \\ \text{Bảng giá đất} \end{matrix} \times 60\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất của} \\ \text{loại đất được} \\ \text{công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{matrix} \times 60\% $$
...
a) Đối với phần diện tích đất được công nhận trong hạn mức giao đất ở theo quy định tại khoản 2 Điều 195, khoản 2 Điều 196 Luật Đất đai, nay được

15

cấp Giấy chứng nhận vào mục đích đất ở theo quy định tại điểm b khoản 3 Điều 138 Luật Đất đai:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được công nhận} \\ \text{trong hạn mức giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 40\% $$

b) Đối với phần diện tích đất được công nhận vượt hạn mức giao đất ở theo quy định tại khoản 2 Điều 195, khoản 2 Điều 196 Luật Đất đai, nay được cấp Giấy chứng nhận vào mục đích đất ở theo quy định tại điểm a khoản 3 Điều 138 Luật Đất đai:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{công nhận vượt hạn} \\ \text{mức giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở} \\ \text{quy định tại} \\ \text{Bảng giá đất} \end{matrix} \times 70\% $$
...
$$ \begin{matrix} \text{Tiền sử} \\ \text{dụng đất} \end{matrix} = \begin{matrix} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{matrix} \times 70\% $$
...
$$ \begin{matrix} \text{Tiền sử} \\ \text{dụng đất} \end{matrix} = \begin{matrix} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công} \\ \text{nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại} \\ \text{đất được công} \\ \text{nhận quy định tại} \\ \text{Bảng giá đất} \end{matrix} \times 70\% $$
...
1. Đối với hộ gia đình, cá nhân sử dụng đất trước ngày 18 tháng 12 năm 1980 nay được cơ quan nhà nước có thẩm quyền cấp Giấy chứng nhận vào mục

16

đích đất ở theo quy định tại khoản 1, điểm c khoản 2, điểm a khoản 3 Điều 139 Luật Đất đai thì tiền sử dụng đất được tính như sau:
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được cấp} \\ \text{Giấy chứng nhận trong} \\ \text{hạn mức công nhận đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 10\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận vượt hạn mức} \\ \text{công nhận đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 30\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{matrix} \times 40\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận trong hạn mức} \\ \text{công nhận đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 20\% $$

b) Đối với phần diện tích đất được cấp Giấy chứng nhận vượt hạn mức công nhận đất ở theo quy định tại khoản 5 Điều 141 Luật Đất đai:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận vượt hạn mức} \\ \text{công nhận đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 50\% $$

17

c) Đối với phần diện tích đất nay được cấp Giấy chứng nhận vào mục đích đất phi nông nghiệp (nếu có) theo quy định tại Nghị định về cấp giấy chứng nhận:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{matrix} \times 60\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận trong hạn mức} \\ \text{giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 30\% $$

b) Đối với phần diện tích đất vượt hạn mức giao đất ở theo quy định tại khoản 2 Điều 195, khoản 2 Điều 196 Luật Đất đai:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận vượt hạn mức} \\ \text{giao đất ở} \end{matrix} \times \begin{matrix} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{matrix} \times 60\% $$

c) Đối với phần diện tích đất nay được cấp Giấy chứng nhận vào mục đích đất phi nông nghiệp (nếu có) theo quy định tại Nghị định về cấp giấy chứng nhận:

$$ \text{Tiền sử dụng đất} = \begin{matrix} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công nhận} \end{matrix} \times \begin{matrix} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{matrix} \times 70\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{array}{c} \text{Diện tích đất được} \\ \text{cấp Giấy chứng} \\ \text{nhận là đất ở} \end{array} \times \begin{array}{c} \text{Giá đất ở quy định} \\ \text{tại Bảng giá đất} \end{array} \times 80\% $$
...
$$ \text{Tiền sử dụng đất} = \begin{array}{c} \text{Diện tích đất} \\ \text{của loại đất} \\ \text{được công nhận} \end{array} \times \begin{array}{c} \text{Giá đất của loại đất} \\ \text{được công nhận quy} \\ \text{định tại Bảng giá đất} \end{array} \times 80\% $$
...
2. Trường hợp cơ quan nhà nước có thẩm quyền điều chỉnh quyết định giao đất theo quy định tại điểm c khoản 3 Điều 155 Luật Đất đai do thay đổi,

quy hoạch chi tiết thì tiền sử dụng đất được tính theo cách tính quy định tại Điều 14 Nghị định này tại thời điểm được cơ quan nhà nước có thẩm quyền quyết định điều chỉnh quyết định giao đất.
...
$$
\text{Tiền sử dụng đất} = \left( \begin{array}{c} \text{Số tiền sử dụng đất} \\ \text{được tính đối với toàn} \\ \text{bộ dự án theo quy} \\ \text{hoạch chi tiết sau khi} \\ \text{điều chỉnh theo quy} \\ \text{định của pháp luật tại} \\ \text{thời điểm cơ quan nhà} \\ \text{nước có thẩm quyền} \\ \text{quyết định điều chỉnh} \\ \text{quy hoạch chi tiết.} \end{array} - \begin{array}{c} \text{Số tiền sử dụng đất} \\ \text{được tính đối với} \\ \text{toàn bộ dự án theo} \\ \text{quy hoạch chi tiết} \\ \text{trước khi điều chỉnh} \\ \text{theo quy định của} \\ \text{pháp luật tại thời} \\ \text{điểm cơ quan nhà} \\ \text{nước có thẩm quyền} \\ \text{quyết định điều} \\ \text{chỉnh quy hoạch chi} \\ \text{tiết.} \end{array} \right) \text{ x } \frac{\text{Giá trúng đấu giá}}{\text{Giá khởi điểm}}
$$

23

b) Khi có quyết định điều chỉnh cục bộ quy hoạch chi tiết dự án (một phần diện tích dự án) của cơ quan nhà nước có thẩm quyền thì tiền sử dụng đất được tính như sau:

$$
\text{Tiền sử dụng đất} = \left( \begin{matrix} \text{Số tiền sử dụng đất} \\ \text{được tính đối với} \\ \text{phần diện tích được} \\ \text{điều chỉnh cục bộ} \\ \text{theo quy hoạch chi tiết} \\ \text{sau khi điều chỉnh} \\ \text{theo quy định của} \\ \text{pháp luật tại thời điểm} \\ \text{cơ quan nhà nước có} \\ \text{thẩm quyền quyết định} \\ \text{điều chỉnh quy hoạch} \\ \text{chi tiết.} \end{matrix} - \begin{matrix} \text{Số tiền sử dụng đất} \\ \text{được tính đối với} \\ \text{phần diện tích được} \\ \text{điều chỉnh cục bộ} \\ \text{theo quy hoạch chi} \\ \text{tiết trước khi điều} \\ \text{chỉnh theo quy định} \\ \text{của pháp luật tại thời} \\ \text{điểm cơ quan nhà} \\ \text{nước có thẩm quyền} \\ \text{quyết định điều} \\ \text{chỉnh quy hoạch chi} \\ \text{tiết.} \end{matrix} \right) \times \frac{\text{Giá trúng đấu giá}}{\text{Giá khởi điểm}}
$$
...
4. Trường hợp tổ chức kinh tế, người gốc Việt Nam định cư ở nước ngoài, tổ chức có vốn đầu tư nước ngoài đã thoả thuận nhận chuyển nhượng quyền sử dụng đất để thực hiện dự án theo quy định tại Điều 127 Luật Đất đai mà phải điều chỉnh quy hoạch chi tiết của dự án thì tính tiền sử dụng đất theo quy định tại các khoản 1, 2 và 3 Điều này.
...
$$ \text{Khoản tiền bổ sung} = \text{Diện tích đất được gia hạn sử dụng đất} \times \frac{\text{Giá đất trong Bảng giá đất tại thời điểm cơ quan nhà nước có thẩm quyền ban hành quyết định gia hạn sử dụng đất}}{1} \times 2\% \times \frac{\text{Thời gian gia hạn (tháng)}}{12} $$
...
a4) Bảng kê thanh toán kinh phí bồi thường, hỗ trợ, tái định cư do đơn vị, tổ chức thực hiện nhiệm vụ bồi thường, hỗ trợ, tái định cư lập; trong đó có các

nội dung về số tiền đã chi trả, số chứng từ chi trả, ngày, tháng chi tiền, người nhận tiền: 01 bản chính.
...
đ) Diện tích đất tại dự án đầu tư hạ tầng nghĩa trang để chuyển nhượng quyền sử dụng đất gắn với hạ tầng, xây dựng cơ sở lưu giữ cốt mà chủ đầu tư bố trí để phục vụ mai táng cho các đối tượng chính sách xã hội theo quy định của pháp luật về xây dựng, quản lý, sử dụng nghĩa trang và cơ sở hỏa táng.
...
5. Giảm tiền sử dụng đất theo quy định của pháp luật đầu tư và pháp luật có liên quan đối với trường hợp sử dụng đất thực hiện dự án đầu tư hạ tầng nghĩa trang để chuyển nhượng quyền sử dụng đất gắn với hạ tầng, xây dựng cơ sở lưu giữ cốt theo quy định tại điểm a khoản 1 Điều 157 Luật Đất đai:
...
$$
\begin{matrix}
\text{Tiền sử} \\ \text{dụng đất} \\ \text{phải nộp}
\end{matrix}
=
\begin{matrix}
\text{Tiền sử dụng} \\ \text{đất được tính} \\ \text{theo quy định} \\ \text{tại khoản 1} \\ \text{Điều này}
\end{matrix}
-
\begin{matrix}
\text{Tiền sử dụng đất} \\ \text{được giảm theo} \\ \text{quy định tại Điều} \\ \text{19 Nghị định này} \\ \text{(nếu có)}
\end{matrix}
-
\begin{matrix}
\text{Kinh phí bồi} \\ \text{thường, hỗ trợ, tái} \\ \text{định cư được trừ} \\ \text{vào tiền sử dụng đất} \\ \text{theo quy định tại} \\ \text{Điều 16 Nghị định} \\ \text{này (nếu có)}
\end{matrix}
$$
...
Đối với trường hợp quy định tại khoản 5 Điều 6 Nghị định này, ngoài hồ sơ nêu trên chủ đầu tư phải nộp thêm hồ sơ theo quy định tại Nghị định của Chính phủ quy định chi tiết một số điều của Luật Nhà ở về phát triển và quản lý nhà ở xã hội.
...
Phiếu chuyển thông tin cho cơ quan thuế để tính tiền sử dụng đất theo quy định của pháp luật về cấp giấy chứng nhận.
...
6. Trường hợp phải hoàn trả tiền sử dụng đất đã được miễn, giảm theo quy định tại khoản 6, khoản 7 Điều 17 Nghị định này thì số tiền sử dụng đất phải hoàn trả được tính theo chính sách và giá đất tại thời điểm giao đất, cho phép chuyển mục đích sử dụng đất, công nhận quyền sử dụng đất. Cơ quan thuế thu

hồi số tiền sử dụng đất đã được miễn, giảm sau khi báo cáo và được Ủy ban nhân dân cùng cấp chấp thuận.
...
b) Sau khi hoàn thành việc thanh toán nợ tiền sử dụng đất quy định tại điểm a khoản này thì hộ gia đình, cá nhân nộp hồ sơ gồm: Giấy chứng nhận (bản gốc), chứng từ nộp tiền sử dụng đất (bản gốc) hoặc Thông báo về việc xác nhận việc hoàn thành nghĩa vụ tài chính về thu tiền sử dụng đất (bản gốc) tại
...
4. Hình thức Nhà nước cho thuê đất trả tiền thuê đất hàng năm hoặc cho thuê đất trả tiền thuê đất một lần cho cả thời gian thuê.
...
2. Diện tích tính tiền thuê đất đối với trường hợp công nhận quyền sử dụng đất thuê là diện tích đất được công nhận theo Phiếu chuyển thông tin xác định

40

nghĩa vụ tài chính về đất đai do cơ quan có chức năng quản lý đất đai chuyển đến cơ quan thuế theo quy định tại Nghị định về cấp giấy chứng nhận hoặc theo Hợp đồng thuê đất đã ký.

3. Diện tích tính tiền thuê đất theo quy định tại khoản 1, khoản 2 Điều này được tính theo đơn vị mét vuông (m²).
...
b) Giá đất để tính tiền thuê đất là giá đất trong Bảng giá đất (theo quy định tại điểm b, điểm h khoản 1 Điều 159 Luật Đất đai); được xác định theo đơn vị đồng/mét vuông (đồng/m²).
...
$$
\begin{matrix} \text{Đơn giá thuê} \\ \text{đất trả tiền} \\ \text{thuê đất một} \\ \text{lần cho cả} \\ \text{thời gian thuê} \end{matrix} = \frac{\text{Giá đất theo mục đích sử dụng đất thuê trong Bảng giá đất}}{\begin{matrix} \text{Thời hạn sử dụng đất của giá đất trong Bảng} \\ \text{giá đất (theo quy định của Chính phủ về giá} \\ \text{đất)} \end{matrix}} \times \begin{matrix} \text{Thời hạn} \\ \text{thuê đất} \end{matrix}
$$
...
3. Trường hợp đấu giá quyền sử dụng đất thì đơn giá thuê đất là đơn giá trúng đấu giá tương ứng với hình thức Nhà nước cho thuê đất trả tiền thuê đất hằng năm hoặc cho thuê đất trả tiền thuê đất một lần cho cả thời gian thuê.
...
3. Đối với đất xây dựng công trình ngầm gắn với phần ngầm công trình xây dựng trên mặt đất mà có phần diện tích xây dựng công trình ngầm vượt ra

42

ngoài phần diện tích đất trên bề mặt được Nhà nước giao đất có thu tiền sử dụng đất, cho thuê đất cho người sử dụng đất đó thì đơn giá thuê đất của phần diện tích vượt này được xác định theo quy định tại khoản 2 Điều này.
...
$$ \text{Tiền thuê đất một năm} = \text{Diện tích tính tiền thuê đất theo quy định tại Điều 24 Nghị định này} \times \text{Đơn giá thuê đất hằng năm theo quy định tại khoản 1 Điều 26, khoản 1, điểm a khoản 2 Điều 27, khoản 1, khoản 2 Điều 28 Nghị định này} $$
...
$$ \text{Tiền thuê đất trả một lần cho cả thời gian thuê} = \text{Diện tích tính tiền thuê đất theo quy định tại Điều 24 Nghị định này} \times \text{Đơn giá thuê đất trả tiền thuê đất một lần cho cả thời gian thuê quy định tại khoản 2 Điều 26, điểm b khoản 2 Điều 27, khoản 1, khoản 2 Điều 28 Nghị định này} $$

b) Tiền thuê đất có mặt nước trả một lần cho cả thời gian thuê được tính như sau:

$$ \text{Tiền thuê đất có mặt nước trả một lần cho cả thời gian thuê} = \text{Tiền thuê đất của phần diện tích đất không có mặt nước} + \text{Tiền thuê đất của phần diện tích đất có mặt nước} $$
...
$$ \text{Khoản tiền bổ sung} = \text{Diện tích đất được gia hạn sử dụng đất} \times \begin{matrix} \text{Giá đất trong Bảng giá đất tại} \\ \text{thời điểm cơ quan có thẩm quyền} \\ \text{ban hành Quyết định gia hạn sử} \\ \text{dụng đất} \end{matrix} \times \begin{matrix} \text{Tỷ lệ (%) tính đơn giá} \\ \text{thuê đất do Ủy ban} \\ \text{nhân dân cấp tỉnh quy} \\ \text{định} \end{matrix} \times \frac{\text{Thời gian gia hạn (tháng)}}{12} $$
...
$$ \text{Kinh phí chưa khấu trừ hết} = \begin{matrix} \text{Số năm, tháng đã được quy đổi} \\ \text{hoàn thành nghĩa vụ về tiền} \\ \text{thuê đất nhưng chưa sử dụng} \end{matrix} \times \begin{matrix} \text{Đơn giá thuê đất trả tiền thuê đất hằng} \\ \text{năm tại thời điểm Nhà nước quyết định} \\ \text{phê duyệt phương án bồi thường, hỗ trợ,} \\ \text{tái định cư} \end{matrix} $$
...
$$ \text{Kinh phí chưa khấu trừ hết} = \begin{matrix} \text{Tổng số kinh phí bồi thường, hỗ} \\ \text{trợ, tái định cư được khấu trừ} \\ \text{theo quy định} \end{matrix} - \begin{matrix} \text{Số kinh phí bồi thường,} \\ \text{hỗ trợ, tái định cư đã thực} \\ \text{hiện khấu trừ} \end{matrix} $$
...
$$
Chi phí đầu tư vào đất còn lại = \frac{Tiền thuê đất một năm xác định tại thời điểm Nhà nước quyết định phê duyệt phương án bồi thường, hỗ trợ, tái định cư}{Thời hạn đã trả trước tiền thuê đất còn lại}
$$
...
3. Trường hợp được khấu trừ kinh phí bồi thường, hỗ trợ, tái định cư hoặc được trừ khoản tiền đã trả để nhận chuyển nhượng quyền sử dụng đất vào tiền thuê đất theo hình thức quy đổi ra số năm, tháng hoàn thành nghĩa vụ về tiền

thuê đất theo quy định thì không phải làm thủ tục điều chỉnh tiền thuê đất theo
quy định tại khoản 2 Điều này trong thời gian được xác định đã hoàn thành
nghĩa vụ tiền thuê đất. Sau khi kết thúc thời gian được xác định hoàn thành
nghĩa vụ tiền thuê đất nêu trên thì thực hiện điều chỉnh tiền thuê đất theo quy
định tại khoản 2 Điều này để tính số tiền thuê đất cho thời gian tiếp theo.
...
$$
Tiền thuê đất phải nộp = \frac{Số tiền thuê đất trả một lần của cả thời gian thuê đất}{Thời hạn thuê đất} \times Thời gian đã sử dụng đất
$$
...
$$
\begin{matrix}
\text{Tiền thuê đất trả} \\ \text{một lần cho cả thời} \\ \text{gian thuê khi} \\ \text{chuyển mục đích}
\end{matrix}
=
\begin{matrix}
\text{Tiền thuê đất của loại} \\ \text{đất sau khi chuyển} \\ \text{mục đích của thời} \\ \text{gian thuê đất còn lại}
\end{matrix}
-
\begin{matrix}
\text{Tiền thuê đất của loại} \\ \text{đất trước khi chuyển} \\ \text{mục đích của thời gian} \\ \text{thuê đất còn lại}
\end{matrix}
$$
...
Tiền thuê đất khi = Tiền thuê đất trả một lần của thời gian - Số tiền sử dụng
được chuyển mục = sử dụng đất còn lại của loại đất sau khi - đất đã nộp
dịch sử dụng đất chuyển mục đích sử dụng đất
...
Tiền đất trước khi chuyển mục đích sử dụng đất được trừ vào số tiền thuê đất phải nộp nếu lựa chọn hình thức thuê đất trả tiền một lần cho cả thời gian thuê. Trường hợp người được Nhà nước cho thuê đất lựa chọn hình thức thuê đất trả tiền hằng năm thì tiền đất trước khi chuyển mục đích sử dụng đất được quy đổi

ra thời gian đã hoàn thành nghĩa vụ nộp tiền thuê đất tại thời điểm được cơ quan nhà nước có thẩm quyền cho phép chuyển mục đích sử dụng đất.
...
b2) Trường hợp điều chỉnh thời hạn sử dụng đất của dự án đồng thời thay đổi quy hoạch chi tiết của dự án thì tiền thuê đất được tính bằng (=) chênh lệch giữa tiền thuê đất trả một lần cho cả thời gian thuê của thời hạn sử dụng đất đã

được điều chỉnh theo quyết định của cơ quan nhà nước có thẩm quyền và tiền thuê đất đã trả một lần của thời gian sử dụng đất còn lại của thời hạn thuê đất theo quy hoạch chi tiết trước khi được điều chỉnh.
...
$$
\text{Tiền thuê đất} = \left( \begin{matrix} \text{Số tiền thuê đất được} \\ \text{tính đối với toàn bộ dự} \\ \text{án theo quy hoạch chi} \\ \text{tiết sau khi điều chỉnh} \\ \text{theo quy định của} \\ \text{pháp luật tại thời điểm} \\ \text{cơ quan nhà nước có} \\ \text{thẩm quyền quyết định} \\ \text{điều chỉnh quy hoạch} \\ \text{chi tiết.} \end{matrix} - \begin{matrix} \text{Số tiền thuê đất được} \\ \text{tính đối với toàn bộ dự} \\ \text{án theo quy hoạch chi} \\ \text{tiết trước khi điều chỉnh} \\ \text{theo quy định của pháp} \\ \text{luật tại thời điểm cơ} \\ \text{quan nhà nước có thẩm} \\ \text{quyền quyết định điều} \\ \text{chỉnh quy hoạch chi} \\ \text{tiết.} \end{matrix} \right) \text{ x } \frac{\text{Giá trúng đấu giá}}{\text{Giá khởi điểm}}
$$
...
$$
\text{Tiền thuê đất} = \left( \begin{array}{c} \text{Số tiền thuê đất được} \\ \text{tính đối với phần diện} \\ \text{tích được điều chỉnh} \\ \text{cục bộ theo quy hoạch} \\ \text{chi tiết sau khi điều} \\ \text{chỉnh theo quy định} \\ \text{của pháp luật tại thời} \\ \text{điểm cơ quan nhà} \\ \text{nước có thẩm quyền} \\ \text{quyết định điều chỉnh} \\ \text{quy hoạch chi tiết.} \end{array} - \begin{array}{c} \text{Số tiền thuê đất được} \\ \text{tính đối với phần diện} \\ \text{tích được điều chỉnh} \\ \text{cục bộ theo quy hoạch} \\ \text{chi tiết trước khi điều} \\ \text{chỉnh theo quy định} \\ \text{của pháp luật tại thời} \\ \text{điểm cơ quan nhà} \\ \text{nước có thẩm quyền} \\ \text{quyết định điều chỉnh} \\ \text{quy hoạch chi tiết.} \end{array} \right) \times \frac{\text{Giá trúng đấu giá}}{\text{Giá khởi điểm}}
$$
...
a) Đối với trường hợp được miễn tiền thuê đất theo quy định tại Điều 39 Nghị định này, số tiền thuê đất hằng năm phải nộp tại thời điểm bắt đầu phải

63

nộp tiền thuê đất sau khi đã hết thời gian được miễn tiền thuê đất được xác định như sau:

$$ \begin{matrix} \text{Tiền thuê đất} \\ \text{phải nộp} \end{matrix} = \begin{matrix} \text{Đơn giá thuê đất hằng năm tại thời} \\ \text{điểm bắt đầu phải nộp tiền thuê đất} \end{matrix} \times \begin{matrix} \text{Diện tích phải nộp} \\ \text{tiền thuê đất} \end{matrix} $$
...
$$ \begin{matrix} \text{Số tiền thuê đất phải nộp} \\ \text{của năm được giảm tiền} \\ \text{thuê đất} \end{matrix} = \begin{matrix} \text{Tiền thuê đất của năm} \\ \text{được giảm tiền thuê đất} \end{matrix} \times \begin{matrix} \text{(100\% - Tỷ lệ \%} \\ \text{được giảm tiền thuê} \\ \text{đất)} \end{matrix} $$
...
c1) Trường hợp được miễn tiền thuê đất một số năm theo quy định tại khoản 2 Điều 39 Nghị định này thì sau thời gian được miễn tiền thuê đất một số năm, người thuê đất được tiếp tục khấu trừ kinh phí bồi thường, hỗ trợ, tái định cư bằng cách quy đổi ra số năm, tháng hoàn thành nghĩa vụ về tiền thuê đất theo công thức sau:

$$ n = \frac{\text{Số tiền bồi thường, giải phóng mặt bằng đã ứng trước theo phương án được cơ quan nhà nước có thẩm quyền phê duyệt}}{\text{Tiền thuê đất phải nộp theo quy định tại điểm a khoản này}} $$

Trong đó:

n: Số năm, tháng không phải nộp tiền thuê đất.

c2) Trường hợp được giảm tiền thuê đất thì sau khi trừ đi số tiền được giảm theo quy định tại điểm b khoản này, người sử dụng đất tiếp tục được khấu trừ kinh phí bồi thường, hỗ trợ, tái định cư đã ứng trước mà được cơ quan nhà nước có thẩm quyền xác định cho khấu trừ vào tiền thuê đất phải nộp bằng số tiền tuyệt đối đối với thời gian được giảm tiền thuê đất từng năm; số kinh phí

64

bồi thường, hỗ trợ, tái định cư còn lại (sau khi đã khấu trừ vào tiền thuê đất còn phải nộp hằng năm của thời gian được giảm tiền thuê đất) được khấu trừ tiếp bằng cách quy đổi ra số năm, tháng hoàn thành nghĩa vụ về tiền thuê đất theo đơn giá thuê đất tại thời điểm kết thúc thời gian được miễn, giảm tiền thuê đất theo công thức sau:

$$n = \frac{\text{Kinh phí bồi thường, hỗ trợ, tái định cư đã ứng trước còn lại sau khi đã khấu trừ vào tiền thuê đất còn phải nộp hằng năm của thời gian được giảm tiền thuê đất}}{\text{Tiền thuê đất hằng năm tại thời điểm tính tiền thuê đất theo quy định}}$$
...
$$\begin{matrix} \text{Tiền thuê đất} \\ \text{phải nộp} \end{matrix} = \begin{matrix} \text{Đơn giá thuê đất thu một lần của thời hạn} \\ \text{thuê sau khi đã trừ đi thời gian được miễn} \\ \text{theo quy định tại Điều 39 Nghị định này} \end{matrix} \times \begin{matrix} \text{Diện tích phải} \\ \text{nộp tiền thuê đất} \end{matrix}$$
...
$$\begin{matrix} \text{Tiền} \\ \text{thuê đất} \\ \text{phải nộp} \end{matrix} = \begin{matrix} \text{Đơn giá thuê đất} \\ \text{trả một lần cho} \\ \text{cả thời gian thuê} \end{matrix} \times \begin{matrix} \text{Diện tích} \\ \text{tính tiền} \\ \text{thuê đất} \end{matrix} - \begin{matrix} \text{Số tiền thuê đất được} \\ \text{giảm quy định tại khoản} \\ \text{2 Điều 40 Nghị định này} \end{matrix}$$
...
cả thời gian thuê đã được miễn, giảm tiền thuê đất theo quy định của pháp luật mà nay chuyển nhượng dự án đầu tư gắn với chuyển nhượng quyền sử dụng đất theo đúng quy định của pháp luật:
...
14. Việc miễn tiền thuê đất để thực hiện dự án đầu tư xây dựng nhà ở xã hội để cho thuê, dự án đầu tư cải tạo, xây dựng lại nhà chung cư được thực hiện theo quy định của pháp luật về nhà ở.
...
Trường hợp Giấy chứng nhận đầu tư hoặc Giấy phép đầu tư hoặc Giấy chứng nhận đăng ký đầu tư hoặc Quyết định chủ trương đầu tư của cấp có thẩm quyền đã cấp trước ngày có Quyết định cho thuê đất theo quy định của pháp luật có ghi thời gian xây dựng cơ bản (tiến độ thực hiện dự án) thì căn cứ vào Giấy chứng nhận đầu tư, Giấy phép đầu tư, Giấy chứng nhận đăng ký đầu tư, Quyết định chủ

2. Mã số thuế: [_________________________________________________________]
3. Địa chỉ: [____________________________________________________________]
4. Số điện thoại: [____________________] Email: [__________________________]
5. Tên đại lý thuế hoặc người được uỷ quyền (nếu có): [_______________________]
6. Mã số thuế: [_________________________________________________________]
7. Địa chỉ: [____________________________________________________________]

### II. THÔNG TIN VỀ ĐẤT
1. Thửa đất số: [____________________] Tờ bản đồ số: [____________________]
...
9. Diện tích thửa đất (m<sup>2</sup>):     
...
13. Giá đất tính tiền sử dụng đất (đồng/m<sup>2</sup>):     
...
| ------------------------------- | ------------------------------------- | ----------------------------- |
|                                 | - \<Người nộp thuế>;                  | BAN HÀNH THÔNG BÁO            |
|                                 | - \<Cơ quan tiếp nhận hồ sơ của NNT>; | (Ký, ghi rõ họ tên, đóng dấu) |
...
| TÊN CƠ QUAN THUẾ CẤP TRÊN\<br/>TÊN CƠ QUAN THUẾ\<br/>BAN HÀNH THÔNG BÁO | CỘNG HOÀ XÃ HỘI CHỦ NGHĨA VIỆT NAM\<br/>Độc lập - Tự do - Hạnh phúc |
| ----------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Số: \[\_\_\_\_\_\_\_\_\_] /TB-CT(CCT)                                   | \*...., ngày.... tháng ...... năm .......\*                         |
# THÔNG BÁO NỘP TIỀN
## Về tiền sử dụng đất
...
Căn cứ Phiếu chuyển thông tin địa chính để xác định nghĩa vụ tài chính số [_________] ngày [_________] tháng [_________] năm [_________] của [_________] <*Tên cơ quan tiếp nhận hồ sơ về giải quyết thủ tục đăng ký, cấp giấy chứng nhận quyền sử dụng đất, quyền sở hữu tài sản gắn liền với đất*>...; số liệu xác định của Ủy ban nhân dân cấp huyện về Kinh phí bồi thường, hỗ trợ, tái định cư được trừ vào tiền sử dụng đất phải nộp (nếu có).

... <*Tên cơ quan thuế*>... xác định và thông báo nộp tiền sử dụng đất như sau:

### I. THÔNG TIN VỀ NGƯỜI NỘP THUẾ
1. Tên người sử dụng đất: [________________________________________________________________]
2. Mã số thuế: [__________________________________________________________________________]
3. Địa chỉ: [______________________________________________________________________________]
4. Điện thoại: [________________________]; Email: [_________________________________________]
5. Tên đại lý thuế (nếu có): [_______________________________________________________________]
6. Mã số thuế: [__________________________________________________________________________]
7. Địa chỉ: [______________________________________________________________________________]

### II. THÔNG TIN VỀ ĐẤT
1. Thửa đất số: [____________________] Tờ bản đồ số: [_______________________________________]
2. Địa chỉ:
2.1. Số nhà: [____] Toà nhà: [_________] Ngõ/hẻm: [_________] đường/phố: [_________]
Thôn/xóm/ấp: [___________________________________________________________________________]
2.2. Phường/xã: [_________________________________________________________________________]
2.3. Quận/huyện: [________________________________________________________________________]
2.4. Tỉnh/thành phố: [______________________________________________________________________]
...
11. Giá đất tính tiền sử dụng đất (đồng/m²): ...............................................
...
| CỤC THUẾ:.....\<br/>CHI CỤC THUẾ:..... | CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM\<br/>Độc lập - Tự do - Hạnh phúc |
| -------------------------------------- | ------------------------------------------------------------------- |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| - \<Tên, địa chỉ của người sử dụng đất>; \<br/> - Văn phòng đăng ký đất đai hoặc cơ quan có chức năng quản lý đất đai nơi có đất; \<br/> - \<Tên các bộ phận có liên quan>; \<br/> - Lưu: VT; KK\&KTT. | \*(Ký, ghi rõ họ tên và đóng dấu)\*         |
...
| STT | Tên người sử dụng đất | Mã số thuế | Thông báo nộp tiền sử dụng đất<br/>Số | Thông báo nộp tiền sử dụng đất<br/>Ngày, tháng | Thông báo nộp tiền sử dụng đất<br/>Thời hạn nộp | Thông báo nộp tiền sử dụng đất<br/>Số tiền phải nộp | Theo dõi thu nộp<br/>Số chứng từ | Theo dõi thu nộp<br/>Ngày, tháng | Theo dõi thu nộp<br/>Số tiền đã nộp | Theo dõi thu nộp<br/>Số còn phải nộp | Ghi chú |   |
| --- | --------------------- | ---------- | ------------------------------------- | ---------------------------------------------- | ----------------------------------------------- | --------------------------------------------------- | -------------------------------- | -------------------------------- | ----------------------------------- | ------------------------------------ | ------- | - |
|     |                       |            |                                       |                                                |                                                 |                                                     |                                  |                                  |                                     |                                      |         |   |
|     |                       |            |                                       |                                                |                                                 |                                                     |                                  |                                  |                                     |                                      |         |   |
|     |                       |            |                                       |                                                |                                                 |                                                     |                                  |                                  |                                     |                                      |         |   |
...
| ---------------------- | ------------------------------------ |
| \*(Họ và tên)\*        | \*\*Thủ trưởng cơ quan thuế\*\*      |
...
1. Tên người nộp thuế: [________________________________________________]
2. Mã số thuế: [_______________________________________________________]
...
7. Diện tích đất thuê (m<sup>2</sup>):     
...
1. Tên người nộp thuế: [________________________________________________]
2. Mã số thuế: [_______________________________________________________]
3. Địa chỉ: [__________________________________________________________]
4. Số điện thoại: [________________] Email: [___________________________]
5. Tên đại lý thuế (nếu có): [___________________________________________]
6. Mã số thuế: [_______________________________________________________]
7. Địa chỉ: [__________________________________________________________]
...
- Diện tích đất thuê............... m<sup>2</sup>; trong đó: diện tích phải nộp tiền thuê đất..... m<sup>2</sup>, diện tích không phải nộp tiền thuê đất..... m<sup>2</sup> *(ghi rõ bằng số và bằng chữ, đơn vị là mét vuông và theo Quyết định cho thuê đất).*
...
| TT | Họ, tên người sử dụng đất | Bàn giao "Thông báo nộp các khoản nghĩa vụ tài chính"<br/>Ngày bàn giao | Bàn giao "Thông báo nộp các khoản nghĩa vụ tài chính"<br/>Thông báo nộp tiền | Bàn giao "Thông báo nộp các khoản nghĩa vụ tài chính"<br/>Thông báo nộp tiền<br/>Số | Bàn giao "Thông báo nộp các khoản nghĩa vụ tài chính"<br/>Người giao (ký tên, ghi rõ họ tên) | Bàn giao "Thông báo nộp các khoản nghĩa vụ tài chính"<br/>Người nhận (ký tên, ghi rõ họ tên) | Ngày |   |   |
| -- | ------------------------- | ----------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ---- | - | - |
| 1  | 2                         | 3                                                                       | 4                                                                            | 5                                                                                   | 6                                                                                            | 7                                                                                            |      |   |   |
|    |                           |                                                                         |                                                                              |                                                                                     |                                                                                              |                                                                                              |      |   |   |
|    |                           |                                                                         |                                                                              |                                                                                     |                                                                                              |                                                                                              |      |   |   |
